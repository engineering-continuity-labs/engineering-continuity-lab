...
| ECL-FR-020–021; ECL-SC-016–019 | ECL-AC-020–022 | `ui/dist/model.js`, `ui/dist/app.js`, `ui/dist/index.html` | `ui/tests/model.test.js`, static JavaScript checks | PARTIAL — model and departure calculations are tested; rendered UI behavior is not automated. |
...
| ECL-FR-033–034; ECL-NFR-014 | ECL-AC-043–045 | `src/continuity/explorer.py`, `src/continuity/cli.py`, `ui/dist/app.js`, `ui/dist/index.html` | `tests/test_explorer.py`, `ui/tests/pages-static.test.js`, static JavaScript checks | PARTIAL — API and CLI dispatch are automated; rendered browser flow and browser-launch fallback remain manual. |
| ECL-FR-035–036; ECL-NFR-015 | ECL-AC-046–049 | `ui/dist/index.html`, `ui/dist/app.js`, `ui/dist/pages.css` | `ui/tests/model.test.js`, `ui/tests/pages-static.test.js`, static JavaScript checks | PARTIAL — view state and aggregation helpers are automated; rendered local/hosted flows remain manual. |
