...
| ECL-AC-052 | **Given** a visitor sees a report-opening or sample-navigation action, **when** they read its label, **then** it identifies a saved JSON report or the eShop sample destination and does not imply a download. |
